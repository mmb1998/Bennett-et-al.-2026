function play_sound_on_trig(freq_hz, t, ramp, trigger_enable, repeat_enable, repeat_times, stimulus_enable, stim_time, delay_enable, delay_time)%nidaq sampling rate
global Fs;
Fs = 16000; %Hz
...
nidaq_do_channel_start = 'port1/line1'; %imaging acquisition start trigger_enable %for triggering 2p acquisition, also can use for finding timing of sound start
nidaq_do_channel_stimulus = 'port1/line0'; %stimulus_enable (e.g. red light for CsChrimson)
nidaq_samp_rate = Fs;
