function play_sound_song(stimulus,delay_enable)
global Fs;
Fs = 16000; %Hz
...
nidaq_do_channel_start = "port0/line1"; %imaging acquisition start trigger
...
ramp=0.05; %was 0.05
pre=15; %was 5
len=60; %duration of sound delivery, was 0.5
post=15; %was 0.1
nreps=1;
amp = 0.02; %multiplier for daq output
...
y = 10.*pulstran(0:1/Fs:len,0:0.035:len,'gauspuls',220,0.9); %220 Hz as in Zhou 2015
